      ...
      mentors: [
        {
          ...
          image: { url: '/images/mentor-explaining.png', alt: 'Portrait of Marek Novák' },
        },
        {
          name: 'Dr. Lucia Bieliková',
          role: 'Business Strategy',
          bio: 'Specialises in market-entry strategies for DeepTech startups.',
          image: { url: '/images/students-success.png', alt: 'Portrait of Lucia Bieliková' },
        },
        {
          name: 'Ing. Peter Horák',
          role: 'Hardware & Prototyping',
          bio: 'Helps teams go from breadboard to manufacturable product.',
          image: { url: '/images/students-clients.png', alt: 'Portrait of Peter Horák' },
        },
        {
      ...
      mentors: [
        {
          ...
          image: { url: '/images/mentor-explaining.png', alt: 'Portrét Mareka Nováka' },
        },
        {
          name: 'Dr. Lucia Bieliková',
          role: 'Biznis stratégia',
          bio: 'Špecializuje sa na stratégie vstupu na trh pre DeepTech startupy.',
          image: { url: '/images/students-success.png', alt: 'Portrét Lucie Bielikovej' },
        },
        {
          name: 'Ing. Peter Horák',
          role: 'Hardvér a prototypovanie',
          bio: 'Pomáha tímom dostať sa od prototypu k vyrobiteľnému produktu.',
          image: { url: '/images/students-clients.png', alt: 'Portrét Petra Horáka' },
        },
        {
          name: 'Mgr. Eva Kováčová',
