...
const SHELL_STYLES = {
  auth: {
    ...
    frame:
      'grid w-full grid-cols-1 overflow-hidden border border-border bg-muted lg:grid-cols-[400px_1fr]',
    ...
    section: 'flex items-center bg-background px-5 py-7 sm:px-8 sm:py-10 lg:px-12',
  ...
  admin: {
    ...
    frame:
      'mx-auto grid min-h-[calc(100vh-4rem)] w-full max-w-6xl overflow-hidden rounded-[28px] border border-border bg-card shadow-sm lg:grid-cols-[420px_1fr]',
